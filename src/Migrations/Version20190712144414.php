 ...
 */
final class Version20190712144414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD category_id INT DEFAULT NULL, DROP category');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD category VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP category_id');
    }
}
